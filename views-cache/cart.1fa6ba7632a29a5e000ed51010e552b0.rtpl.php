                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount">R$ <?php echo formatPrice($cartProductsInfo["vlprice"]); ?></span></td>
                                            </tr>

                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td><?php if( isset($cart["vlfreight"]) ){ ?> R$ <?php echo formatPrice($cart["vlfreight"]); ?> <?php }else{ ?> R$ 0 <?php } ?> <?php if( $cart["nrdays"] > 0 ){ ?> <small>prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small><?php } ?></td>
                                            </tr>

                                            <tr class="order-total">
                                                <th>Total</th>
                                                <td><strong><span class="amount">R$ <?php echo formatPrice($cartProductsInfo["vlprice"] + $cart["vlfreight"]); ?></span></strong> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
